...
function NavBar() {
  return (
    <div className="flex justify-between items-center w-screen h-16 border-b-[1px] border-solid border-[#C6C6C6] bg-white">
      {/* 로고 */}
      <button
        className="flex-1 text-left text-2xl font-LexendDeca font-bold ml-5"
        type="button"
      >
      ...
      {/* 검색창 */}
      <div className="flex flex-2 w-[36rem] h-10 rounded-xl border-[1px] border-solid border-[#C6C6C6] bg-[#F9F9F9]">
