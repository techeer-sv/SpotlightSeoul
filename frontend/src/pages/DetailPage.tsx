...
function DetailPage() {
  return (
    <div className="flex flex-col items-center">
      <NavBar />
      <div className="flex justify-center items-center w-11/12 h-auto mx-0 mt-10">
        {/* 대표이미지 */}
        <img
          src={SampleImage1}
          alt="SampleImage1"
          className="w-2/5 h-3/5 mx-16 myrounded bg-no-repeat shadow-md"
        />
        {/* 공연 세부정보 */}
        <div className="flex flex-col items-start mx-16">
          ...
          {/* 홈페이지 바로가기 */}
          <div className="flex justify-center items-center mt-16 w-48 h-16 bg-[#252525] rounded-lg border-2 border-solid border-[#FFF] text-white font-LexendDeca text-center text-lg font-medium">
            홈페이지 바로가기
          </div>
        </div>
      </div>
